...
#
# Project: Ecli
# File: src/ecli/extensions/linters/tflint/package_contract.py
...
"""Package delivery contract skeleton for the TFLint microservice."""
...
PACKAGE_CONTRACT = PackageContract(
    ...
    source_url="https://github.com/terraform-linters/tflint",
)
