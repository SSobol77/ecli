...
#
# Project: Ecli
# File: src/ecli/extensions/linters/core/models.py
...
"""Data contracts for normalized F4 linter diagnostics.

Every linter microservice under ``ecli.extensions.linters`` produces and
consumes these normalized types. The F4 Diagnostics Panel renders this
contract only -- it never needs to know which provider produced a given
``Diagnostic``. See ``docs/architecture/ecli-f4-linter-microservices-design.md``.
"""
