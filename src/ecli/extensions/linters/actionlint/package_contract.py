...
#
# Project: Ecli
# File: src/ecli/extensions/linters/actionlint/package_contract.py
...
"""Package delivery contract skeleton for the actionlint microservice."""
...
PACKAGE_CONTRACT = PackageContract(
    service_name="actionlint",
    mandatory_for_full_install=True,
    bundled_with_full_install=True,
    binary_names=("actionlint",),
    version_probe=("actionlint", "-version"),
