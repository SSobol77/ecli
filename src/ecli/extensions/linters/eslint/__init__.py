...
#
# Project: Ecli
# File: src/ecli/extensions/linters/eslint/__init__.py
...
"""ESLint linter microservice (manifest/package-contract skeleton only).
...
from ecli.extensions.linters.eslint import (
    manifest,
    package_contract,
)
