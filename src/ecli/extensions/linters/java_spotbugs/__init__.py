...
#
# Project: Ecli
# File: src/ecli/extensions/linters/java_spotbugs/__init__.py
...
"""SpotBugs linter microservice (manifest/package-contract skeleton only).
...
from ecli.extensions.linters.java_spotbugs import (
    manifest,
    package_contract,
)
