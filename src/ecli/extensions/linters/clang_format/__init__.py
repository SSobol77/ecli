...
#
# Project: Ecli
# File: src/ecli/extensions/linters/clang_format/__init__.py
...
"""Clang-Format linter microservice (manifest/package-contract skeleton only).
...
from ecli.extensions.linters.clang_format import (
    manifest,
    package_contract,
)
